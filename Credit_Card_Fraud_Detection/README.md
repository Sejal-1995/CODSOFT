...
Credit Card Fraud has become a major concern with the growing use of online transactions. The aim of this project is to build a machine learning model that can identify whether a credit card transaction is genuine or fraudulent.

In this project, I used the Credit Card Fraud Detection dataset and applied Logistic Regression to classify transactions. Since the dataset contained significantly more genuine transactions than fraudulent ones, I used undersampling to balance the data before training the model.
...
Dataset:  
The dataset contains credit card transactions labeled as either:  
Genuine Transaction (0) | Fraud Transaction (1)  
...
7.Evaluated the model using Accuracy, Precision, Recall, F1 Score and Confusion Matrix:  
    ...
    F1 Score: 93.05%
Data Visualization:  
To better understand the dataset and model performance, I created the following visualizations-  
